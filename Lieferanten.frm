...
Begin VB.Form frmLieferantenWahl 
   ...
   Begin VB.ListBox lstLieferantenWahl 
      Height          =   5325
      ItemData        =   "Lieferanten.frx":030A
      Left            =   480
      List            =   "Lieferanten.frx":0311
      TabIndex        =   0
      Top             =   240
      Visible         =   0   'False
      Width           =   2535
...
Private Const DefErrModul = "LIEFERANTEN.FRM"

Private Sub chkLieferantenWahlOption_Click(Index As Integer)
'DefErr!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Call DefErrFnc("chkLieferantenWahlOption_Click")
...
'        fmeLieferantenWahlManuell.Visible = True
        fmeLieferantenWahlManuell.Enabled = True
        color& = vbWindowBackground
    Else
'        fmeLieferantenWahlManuell.Visible = False
        fmeLieferantenWahlManuell.Enabled = False
        color& = vbGrayText
    End If
End If

For i% = 0 To 4
    txtLieferantenWahl(i%).BackColor = color&
Next i%
...
chkLieferantenWahlOption(0).Left = wpara.LinksX
...
fmeLieferantenWahlManuell.Enabled = False
For i% = 0 To 4
    txtLieferantenWahl(i%).BackColor = vbGrayText
Next i%
...
'DefErr!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Call DefErrFnc("txtLieferantenWahl_GotFocus")
Call DefErrMod(DefErrModul)
On Error GoTo DefErr
GoTo DefErrEnd
DefErr:
