...
Begin VB.Form frmBarVerkauf 
   AutoRedraw      =   -1  'True
   Caption         =   "Dazugehörige Barverkäufe"
   ClientHeight    =   4185
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4320
   ...
   Begin VB.CommandButton cmdEsc 
      ...
      Width           =   1200
   End
   Begin MSFlexGridLib.MSFlexGrid flxBarVerkauf 
      Height          =   1800
      Left            =   0
      TabIndex        =   0
      Top             =   360
   ...
   End
End
Attribute VB_Name = "frmBarVerkauf"
...
Private Const DefErrModul = "BARVERKAUF.FRM"
...
With flxBarVerkauf
    ...
    Call ActProgram.FlxBarVerkaufBefuellen
    
    .ColWidth(0) = TextWidth(String(45, "X"))
    .Width = .ColWidth(0) + 90
...
Me.Width = flxBarVerkauf.Left + flxBarVerkauf.Width + 2 * wpara.LinksX

With cmdEsc
    .Top = flxBarVerkauf.Top + flxBarVerkauf.Height + 150 * wpara.BildFaktor
    .Width = wpara.ButtonX%
...
'        .Left = Me.ScaleWidth - .Width - 150
        .Top = flxBarVerkauf.Top + flxBarVerkauf.Height + iAdd + 600
