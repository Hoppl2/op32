...
Begin VB.Form frmHmAbrechnungsKz 
   AutoRedraw      =   -1  'True
   Caption         =   "Auswahl des Hersteller-Schlüssels"
   ClientHeight    =   4245
   ClientLeft      =   1650
   ClientTop       =   1545
   ClientWidth     =   6570
   ...
   Begin VB.PictureBox picControlBox 
      ...
      Index           =   0
      Left            =   5520
      Picture         =   "HmAbrechnungsKz.frx":0000
      ScaleHeight     =   240
      ScaleWidth      =   240
      TabIndex        =   5
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox picControlBox 
      ...
      Index           =   1
      Left            =   5760
      Picture         =   "HmAbrechnungsKz.frx":00A9
      ScaleHeight     =   240
      ScaleWidth      =   240
      TabIndex        =   4
      TabStop         =   0   'False
   ...
   Begin VB.PictureBox picControlBox 
      ...
      Index           =   2
      Left            =   6000
      Picture         =   "HmAbrechnungsKz.frx":015D
      ScaleHeight     =   240
      ScaleWidth      =   240
      TabIndex        =   3
      TabStop         =   0   'False
   ...
   Begin VB.CommandButton cmdEsc 
      ...
      Width           =   1200
   End
   Begin MSFlexGridLib.MSFlexGrid flxHmAbrechnungsKz 
      Height          =   2700
      Index           =   0
      Left            =   0
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmHmAbrechnungsKz"
...
Dim HmAbrechnungsKz_Text$(20)

Private Const DefErrModul = "HMABRECHNUNGSKZ.FRM"
...
With flxHmAbrechnungsKz(0)
    HmAbrechnungsKz = Left(.TextMatrix(.row, 0), 2)
End With
...
Private Sub flxHmAbrechnungsKz_DblClick(index As Integer)
'DefErr!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Call DefErrFnc("flxHmAbrechnungsKz_DblClick")
Call DefErrMod(DefErrModul)
On Error GoTo DefErr
GoTo DefErrEnd
DefErr:
...
Me.Caption = "Auswahl HM-Abrechnungs-Kennzeichen"

iEditModus = 1

ParEnteralHerstellerKey = 1

HmAbrechnungsKz_Text(0) = "Neulieferung"
HmAbrechnungsKz_Text(1) = "Reparatur"
HmAbrechnungsKz_Text(2) = "Wiedereinsatz"
HmAbrechnungsKz_Text(3) = "Miete"
HmAbrechnungsKz_Text(4) = "Nachlieferung"
HmAbrechnungsKz_Text(5) = "Zurichtung"
HmAbrechnungsKz_Text(6) = "Abgabe eines von der Verordnung abweichenden,höherwertigen HM"
HmAbrechnungsKz_Text(7) = "unbesetzt"
HmAbrechnungsKz_Text(8) = "Vergütungspauschale"
HmAbrechnungsKz_Text(9) = "Folgevergütungspauschale"
HmAbrechnungsKz_Text(10) = "Folgeversorgung"
HmAbrechnungsKz_Text(11) = "Ersatzbeschaffung"
HmAbrechnungsKz_Text(12) = "Zubehör"
HmAbrechnungsKz_Text(13) = "Reparaturpauschale"
HmAbrechnungsKz_Text(14) = "Wartung"
HmAbrechnungsKz_Text(15) = "Wartungspauschale"
HmAbrechnungsKz_Text(16) = "Auslieferung"
HmAbrechnungsKz_Text(17) = "Aussonderung"
HmAbrechnungsKz_Text(18) = "Rückholung"
HmAbrechnungsKz_Text(19) = "Abbruch"
HmAbrechnungsKz_Text(20) = "Erprobung"
...
'    For i = 0 To UBound(HmAbrechnungsKz_Text)
'        .AddItem Format(i, "00") + " - " + HmAbrechnungsKz_Text(i)
'        .row = .Rows - 1
'        .col = 0
...
'    Next
    Do
        ...
        If (ind > 0) Then
            h = Left(HmAbrechnungsKz, ind - 1)
            If (Val(h) <= 20) Then
                h = h + " - " + HmAbrechnungsKz_Text(Val(h))
            End If
            .AddItem h
            HmAbrechnungsKz = Mid(HmAbrechnungsKz, ind + 1)
        Else
            Exit Do
        End If
    Loop
'    .AddItem "1 - Kennzeichen des Herstellenden nach DAV-Vorgabe; Apo ist auch Hersteller der Charge"
'    .AddItem "2 - Kennzeichen des Herstellenden nach DAV-Vorgabe; Apo ist nicht Hersteller der Charge"
'    .AddItem "3 - IK des Herstellenden; Apo ist auch Hersteller der Charge (nur übergangsweise)"
'    .AddItem "4 - IK des Herstellenden; Apo ist nicht Hersteller der Charge (nur übergangsweise)"
End With
HmAbrechnungsKz = ""

Font.Bold = False   ' True

cmdOk.Top = flxHmAbrechnungsKz(0).Top + flxHmAbrechnungsKz(0).Height + 150
cmdEsc.Top = cmdOk.Top

Me.Width = flxHmAbrechnungsKz(0).Left + flxHmAbrechnungsKz(0).Width + 2 * wpara.LinksX
...
'        .Left = Me.ScaleWidth - .Width - 150
        .Top = flxHmAbrechnungsKz(0).Top + flxHmAbrechnungsKz(0).Height + iAdd + 600
...
'Private Sub flxPznAuswahl_KeyPress(index As Integer, KeyAscii As Integer)
''DefErr!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'Call DefErrFnc("flxPznAuswahl_KeyPress")
'Call DefErrMod(DefErrModul)
'On Error GoTo DefErr
'GoTo DefErrEnd
'DefErr:
